...
const Greeting = ({ onClickBody, close }) => {
	return (
		<button
			className="p-8 bg-[--neutral] shadow w-[320px] rounded-lg space-y-3 relative text-left"
			onClick={onClickBody}
		>
			<h3 className="">Hi</h3>
			<p>
			...
			<span className="h-[20px] w-[20px] block absolute bottom-0 right-[30px] translate-y-2 bg-[--neutral] rotate-45" />
